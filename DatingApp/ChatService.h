...
#define kNotificationDidReceiveProcessedMessage @"kNotificationDidReceiveProcessMessage"
...
- (void)sendPushMessage:(NSMutableDictionary *)pushMessage toUsers:(NSString *)users successBlock:(void(^)())successBlock errorBlock:(void(^)())errorBlock;
...
- (void)sortDialogsArrayByDate:(NSMutableArray *)messages;
