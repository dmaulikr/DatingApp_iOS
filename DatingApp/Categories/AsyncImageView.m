	...
	if (!self.cancelled)
	{
        if (image && self.URL)
        {
            ...
            if (storeInCache)
            {
                ...
                //NSLog(@"No of Object in cache=%d",self.cache.countLimit);
            }
        }
...
- (void)setImageURL:(NSURL *)imageURL
{
    ...
    //adi code
    BOOL isImagePresent=NO;
    if([self.image isEqual:[UIImage imageNamed:@"no_image_available.png"]])
    {
...
////////////////////////////////////////////////////////////////////////////
    if (self.showActivityIndicator && !isImagePresent && imageURL)
    {
