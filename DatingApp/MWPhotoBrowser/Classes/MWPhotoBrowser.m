...
- (void)performLayout {
    ...
    if ([self.navigationController.viewControllers objectAtIndex:0] == self) {
		...
		//adi code
		UIBarButtonItem *downloadButton = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"Download", nil) style:UIBarButtonItemStylePlain target:self action:@selector(downloadButtonPressed:)];
        // Set appearance
        if ([UIBarButtonItem respondsToSelector:@selector(appearance)]) {
			...
			//adi code
			[downloadButton setBackgroundImage:nil forState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
            [downloadButton setBackgroundImage:nil forState:UIControlStateNormal barMetrics:UIBarMetricsLandscapePhone];
            [downloadButton setBackgroundImage:nil forState:UIControlStateHighlighted barMetrics:UIBarMetricsDefault];
            [downloadButton setBackgroundImage:nil forState:UIControlStateHighlighted barMetrics:UIBarMetricsLandscapePhone];
            [downloadButton setTitleTextAttributes:[NSDictionary dictionary] forState:UIControlStateNormal];
            [downloadButton setTitleTextAttributes:[NSDictionary dictionary] forState:UIControlStateHighlighted];
        }
...
-(void) scrollPage:(NSInteger)pageNum
{
	[_pagingScrollView setContentOffset:CGPointMake(_pagingScrollView.frame.size.width*pageNum,0.0) animated:NO];
}
